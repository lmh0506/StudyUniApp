...
var z=gz$gwx_1()
cs.push("./pages/hello/hello.wxml:view:1:1")
var oB=_n('view')
_rz(z,oB,'bind:__l',0,e,s,gg)
cs.push("./pages/hello/hello.wxml:navigator:1:22")
var xC=_mz(z,'navigator',['openType',1,'url',1],[],e,s,gg)
...
cs.push("./pages/index/index.wxml:navigator:1:38")
var hG=_n('navigator')
_rz(z,hG,'url',2,e,s,gg)
cs.push("./pages/index/index.wxml:image:1:70")
var oH=_mz(z,'image',['class',3,'src',1],[],e,s,gg)
cs.pop()
_(hG,oH)
cs.pop()
_(cF,hG)
...
var cI=_n('view')
cs.push("./pages/index/index.wxml:text:1:139")
var oJ=_n('text')
